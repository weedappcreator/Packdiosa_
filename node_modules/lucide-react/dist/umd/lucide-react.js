...
(function (global, factory) {
  ...
  const AArrowUp = createLucideIcon("a-arrow-up", __iconNode$p1);
  ...
  const ArrowBigDownDash = createLucideIcon("arrow-big-down-dash", __iconNode$o9);

  const __iconNode$o8 = [["path", { d: "M15 6v6h4l-7 7-7-7h4V6h6z", key: "1thax2" }]];
  ...
  const __iconNode$o6 = [["path", { d: "M18 15h-6v4l-7-7 7-7v4h6v6z", key: "lbrdak" }]];
  ...
  const __iconNode$o4 = [["path", { d: "M6 9h6V5l7 7-7 7v-4H6V9z", key: "7fvt9c" }]];
  ...
  const __iconNode$o2 = [["path", { d: "M9 18v-6H5l7-7 7 7h-4v6H9z", key: "1x06kx" }]];
  ...
  const BadgeHelp = createLucideIcon("badge-help", __iconNode$nf);
  ...
  const BadgeIndianRupee = createLucideIcon("badge-indian-rupee", __iconNode$ne);
  ...
  const BadgeInfo = createLucideIcon("badge-info", __iconNode$nd);
  ...
  const BadgeJapaneseYen = createLucideIcon("badge-japanese-yen", __iconNode$nc);
  ...
  const BadgeMinus = createLucideIcon("badge-minus", __iconNode$nb);
  ...
  const BadgePercent = createLucideIcon("badge-percent", __iconNode$na);
  ...
  const BadgePlus = createLucideIcon("badge-plus", __iconNode$n9);
  ...
  const BadgePoundSterling = createLucideIcon("badge-pound-sterling", __iconNode$n8);
  ...
  const BadgeX = createLucideIcon("badge-x", __iconNode$n5);
  ...
  const Badge = createLucideIcon("badge", __iconNode$n4);
  ...
  const BaggageClaim = createLucideIcon("baggage-claim", __iconNode$n3);

  const __iconNode$n2 = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["path", { d: "m4.9 4.9 14.2 14.2", key: "1m5liu" }]
  ];
  const Ban = createLucideIcon("ban", __iconNode$n2);
  ...
  const Banana = createLucideIcon("banana", __iconNode$n1);
  ...
  const Bandage = createLucideIcon("bandage", __iconNode$n0);
  ...
  const BanknoteArrowUp = createLucideIcon("banknote-arrow-up", __iconNode$m_);
  ...
  const Barrel = createLucideIcon("barrel", __iconNode$mW);
  ...
  const Clock5 = createLucideIcon("clock-5", __iconNode$iL);

  const __iconNode$iK = [
    ["path", { d: "M12 16.5V6", key: "1a6ag5" }],
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }]
  ];
  const Clock6 = createLucideIcon("clock-6", __iconNode$iK);
  ...
  const ClockPlus = createLucideIcon("clock-plus", __iconNode$iC);

  const __iconNode$iB = [
    ["circle", { cx: "12", cy: "12", r: "10", key: "1mglay" }],
    ["polyline", { points: "12 6 12 12 16 14", key: "68esgv" }]
  ];
  const Clock = createLucideIcon("clock", __iconNode$iB);
  ...
  const Coins = createLucideIcon("coins", __iconNode$i9);
  ...
  const Columns4 = createLucideIcon("columns-4", __iconNode$i6);
  ...
  const DecimalsArrowRight = createLucideIcon("decimals-arrow-right", __iconNode$hl);
  ...
  const Delete = createLucideIcon("delete", __iconNode$hk);
  ...
  const DiamondMinus = createLucideIcon("diamond-minus", __iconNode$hh);
  ...
  const Dock = createLucideIcon("dock", __iconNode$g_);
  ...
  const EarthLock = createLucideIcon("earth-lock", __iconNode$gG);
  ...
  const Egg = createLucideIcon("egg", __iconNode$gB);
  ...
  const EqualNot = createLucideIcon("equal-not", __iconNode$gx);
  ...
  const EyeClosed = createLucideIcon("eye-closed", __iconNode$gq);
  ...
  const FileBadge = createLucideIcon("file-badge", __iconNode$ga);
  ...
  const FileMusic = createLucideIcon("file-music", __iconNode$fL);
  ...
  const FileOutput = createLucideIcon("file-output", __iconNode$fK);
  ...
  const FileUp = createLucideIcon("file-up", __iconNode$fu);
  ...
  const FileVolume = createLucideIcon("file-volume", __iconNode$fp);
  ...
  const FlashlightOff = createLucideIcon("flashlight-off", __iconNode$f7);
  ...
  const FlipVertical2 = createLucideIcon("flip-vertical-2", __iconNode$f0);
  ...
  const FolderOpen = createLucideIcon("folder-open", __iconNode$eE);
  ...
  const FolderSync = createLucideIcon("folder-sync", __iconNode$ew);
  ...
  const Fullscreen = createLucideIcon("fullscreen", __iconNode$ej);
  ...
  const Gift = createLucideIcon("gift", __iconNode$e4);
  ...
  const GitMerge = createLucideIcon("git-merge", __iconNode$dW);
  ...
  const HopOff = createLucideIcon("hop-off", __iconNode$cS);
  ...
  const LaptopMinimal = createLucideIcon("laptop-minimal", __iconNode$c3);
  ...
  const Ligature = createLucideIcon("ligature", __iconNode$bL);
  ...
  const Link2Off = createLucideIcon("link-2-off", __iconNode$bI);
  ...
  const ListCollapse = createLucideIcon("list-collapse", __iconNode$bC);
  ...
  const MailCheck = createLucideIcon("mail-check", __iconNode$b6);
  ...
  const MailQuestion = createLucideIcon("mail-question", __iconNode$b2);
  ...
  const MessageSquareDot = createLucideIcon("message-square-dot", __iconNode$aj);
  ...
  const MessageSquareLock = createLucideIcon("message-square-lock", __iconNode$ah);
  ...
  const MouseOff = createLucideIcon("mouse-off", __iconNode$9E);
  ...
  const OctagonMinus = createLucideIcon("octagon-minus", __iconNode$8_);
  ...
  const ShoppingBag = createLucideIcon("shopping-bag", __iconNode$5g);
  ...
  const Shrink = createLucideIcon("shrink", __iconNode$59);
  ...
  const Signal = createLucideIcon("signal", __iconNode$51);
  ...
  const SlidersVertical = createLucideIcon("sliders-vertical", __iconNode$4R);
