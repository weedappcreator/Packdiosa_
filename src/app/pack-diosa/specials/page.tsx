/**
 * Pack-DIOSA Specials (bal Pépè) Page
 * Mix pepe, Baby #2, Zaza specials
 */
...
export const metadata = {
  title: "Pack-DIOSA - Specials (bal Pépè)",
  description:
    "Specials from Pack-DIOSA LLC: Mix pepe $550, Baby #2 $700, Zaza $450.",
};

const specialsItems = [
  { id: "1", name: "Mix Pepe", price: 550, category: "specials", description: "Mix pepe special selection", image: "/placeholder.svg?height=400&width=600" },
  { id: "2", name: "Baby #2", price: 700, category: "specials", description: "Baby #2 special", image: "/placeholder.svg?height=400&width=600" },
  { id: "3", name: "Zaza Special", price: 450, category: "specials", description: "Zaza special selection", image: "/placeholder.svg?height=400&width=600" },
];
      ...
      <SR variant="fade-up" stagger={100} className="max-w-7xl mx-auto px-4 py-12">
        ...
        <section className="mb-20">
          ...
          <p className="text-zinc-400 mb-8">
            Special curated selections from bal Pépè collection.
          </p>
        </section>
        ...
        <div className="mt-20 pt-12 border-t border-zinc-800/20">
          <h3 className="text-xl font-display font-bold mb-4">Specials Price Range</h3>
          <p className="text-zinc-500 text-4xl font-display font-bold">
            $450 - $700
          </p>
          <p className="text-zinc-400 text-sm mt-2">
            Curated special selections from bal Pépè collection.
          </p>
        </div>
      </SR>
    </div>
